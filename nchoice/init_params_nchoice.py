...
def helper_d1_srtn(d1_srtn=None):

    d1defaults_srtn = ParamSet('d1defaults_srtn', d1_srtn)

    return d1defaults_srtn


def helper_srtn(srtns=None):

    srtndefaults = ParamSet('srtndefaults', srtns)
