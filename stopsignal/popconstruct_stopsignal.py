...
def helper_popconstruct(
    ...
    popdata = ModifyViaSelector(popdata, srtndefaults, SelName(['dSPN']))
    popdata = ModifyViaSelector(popdata, d1defaults, SelName('dSPN'))
    popdata = ModifyViaSelector(popdata, d2defaults, SelName('iSPN'))
    popdata = ModifyViaSelector(popdata, d1defaults_srtn, SelName('dSPN'))
...
def helper_poppathways(popdata,number_of_choices, newpathways=None):
    ...
    simplepathways = pd.DataFrame(
        [
            ['Cx', 'dSPN', 'AMPA', 'syn', 1, 0.022, True], #True
            ['Cx', 'dSPN', 'NMDA', 'syn', 1, 0.03, False], 
            ['Cx', 'iSPN', 'AMPA', 'syn', 1, 0.022, True], #True
...
#             ['iSPN', 'GPeP', 'GABA', 'syn', 1, 5.0, False], 
            ...
            ['dSPN', 'dSPN', 'GABA', 'syn', 0.26, 0.28, False], #Taverna w: 2/3 * dSPN-iSPN = 2/3 * 0.42 = 0.28
            ['dSPN', 'iSPN', 'GABA', 'syn', 0.06, 0.42, False], #Taverna 
            ['dSPN', 'GPi', 'GABA', 'syn', 1, 2.09, False], #1.8 -- check
            ['dSPN', 'GPeA', 'GABA', 'syn', 0.4, 0.054, False],

            ['iSPN', 'iSPN', 'GABA', 'syn', 0.36, 0.42, False], #Taverna 
            ['iSPN', 'dSPN', 'GABA', 'syn', 0.34, 0.84, False],  #Taverna w: 2 * iSPN-iSPN = 2 * 0.42 = 0.84
            ['iSPN', 'GPeP', 'GABA', 'syn', 1, 4.07, False], 
#             ['iSPN', 'GPeP', 'GABA', 'syn', 1, 5.0, False], 
            ['iSPN', 'GPeA', 'GABA', 'syn', 0.4, 0.61, False],
...
#             ['STN', 'GPi', 'NMDA', 'all', 1, 0.0325, False], 
            ...
            ['Th', 'dSPN', 'AMPA', 'syn', 1, 0.3285, True],   #0.3285 #Set initial value  #New - 5HT implementation 
