...
def helper_update_Q_df(Q_df, Q_support_params, dpmndefaults, srtndefaults, trial_num):
    ...
    if Q_support_params.chosen_action[0] != 'stop' and Q_support_params.chosen_action[0] != 'none':
        ...
        srtn_inc = 1 #Q_support_params.reward_value.values - q_val_chosen.values
        ...
        srtndefaults.srtn_5HT = srtn_inc * Q_support_params.C_scale_srtn
        
        #print("Q_df updated")
        #print(Q_df)

    elif Q_support_params.chosen_action[0] == 'none': 
    ...
    return Q_df, Q_support_params, dpmndefaults, srtndefaults
