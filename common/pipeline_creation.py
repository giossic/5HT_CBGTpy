...
def codeblock_modifysrtndefaults(self):                       #New - 5HT implementation
    self.srtndefaults = self.par.helper_srtn(self.srtns)

def codeblock_modifyd1defaults(self):
    self.d1defaults = self.par.helper_d1(self.d1)

def codeblock_modifyd1defaults_srtn(self):                    #New - 5HT implementation
    self.d1defaults_srtn = self.par.helper_d1_srtn(self.d1_srtn)
...
def codeblock_popconstruct(self):
    self.popdata = self.popconstruct.helper_popconstruct(self.actionchannels, self.popspecific, self.celldefaults, self.receptordefaults, self.basestim, self.dpmndefaults, self.srtndefaults, self.d1defaults, self.d1defaults_srtn, self.d2defaults)
...
def codeblock_update_Q_df(self):
    self.Q_df, self.Q_support_params, self.dpmndefaults, self.srntdefaults = qval.helper_update_Q_df(self.Q_df, self.Q_support_params, self.dpmndefaults, self.srtndefaults, pl.trial_num)
...
#         pl.inter_trial_interval = 600
    ...
    pl.add(codeblock_modifysrtndefaults)     #New - 5HT implementation
    pl.add(codeblock_modifyd1defaults)
    pl.add(codeblock_modifyd1defaults_srtn)  #New - 5HT implementation 
    ...
    pl.popdata = pl[popconstruct.helper_popconstruct](pl.actionchannels, pl.popspecific, pl.celldefaults, pl.receptordefaults, pl.basestim, pl.dpmndefaults, pl.srtndefaults, pl.d1defaults, pl.d1defaults_srtn, pl.d2defaults)    #New - 5HT implementation 
